        ...
        <ul class="list-group">
            <?php foreach( $data['mhs'] as $mhs ) : ?>
                <li class="list-group-item ">
                    ...
                    <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id']; ?>" class="badge text-bg-success float-right tampilModalUbah" data-bs-toggle="modal" data-bs-target="#formModal" data-id="<?= $mhs['id']; ?>">ubah</a>
